...
/*Removing type: installed of core-site-speed-ebay with v1.0.14 installed in site-speed-ebay$5.4.3*/

/*Removing type: installed of cookies-browser with v0.0.2 installed in site-speed-ebay$5.4.3*/

/*Removing type: main of /cookies-browser$0.0.2*/

/*Removing type: installed of cookies-browser with v0.0.2 installed in ebayui-inception$10.1.1*/

/*Removed Lasso-modules-client*/

/*id = 5. Removing type: def of /@ebay/skin$10.7.1/root. Replaced with function declaration __9999ebay__skin_10_7_1__root*/
...
*/
set(function __9999ebay__skin_10_7_1__root(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/root/ds6/root.css')*/
  ;
});

/*id = 6. Removing type: def of /@ebay/skin$10.7.1/global. Replaced with function declaration __9999ebay__skin_10_7_1__global*/
set(function __9999ebay__skin_10_7_1__global(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/global/ds6/global.css')*/
  ;
});

/*id = 7. Removing type: def of /@ebay/skin$10.7.1/utility. Replaced with function declaration __9999ebay__skin_10_7_1__utility*/
set(function __9999ebay__skin_10_7_1__utility(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/utility/ds6/utility.css')*/
  ;
});

/*id = 8. Removing type: def of /@ebay/skin$10.7.1/core. Replaced with function declaration __9999ebay__skin_10_7_1__core*/
set(function __9999ebay__skin_10_7_1__core(require, exports, module, __filename, __dirname) {
  /*id: 5, module: __9999ebay__skin_10_7_1__root*/
  require(get(5));

  /*id: 6, module: __9999ebay__skin_10_7_1__global*/
  require(get(6));

  /*id: 7, module: __9999ebay__skin_10_7_1__utility*/
  require(get(7));
});

/*id = 9. Removing type: def of /@ebay/skin$10.7.1/dialog. Replaced with function declaration __9999ebay__skin_10_7_1__dialog*/
set(function __9999ebay__skin_10_7_1__dialog(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/dialog/ds6/dialog.css')*/
  ;
});

/*id = 10. Removing type: def of /@ebay/skin$10.7.1/button. Replaced with function declaration __9999ebay__skin_10_7_1__button*/
set(function __9999ebay__skin_10_7_1__button(require, exports, module, __filename, __dirname) {
  void 0
  /*require("./dist/button/ds6/button.css")*/
  ;
});

/*id = 11. Removing type: def of /@ebay/skin$10.7.1/checkbox. Replaced with function declaration __9999ebay__skin_10_7_1__checkbox*/
set(function __9999ebay__skin_10_7_1__checkbox(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/checkbox/ds6/checkbox.css')*/
  ;
});

/*id = 12. Removing type: def of /@ebay/skin$10.7.1/field. Replaced with function declaration __9999ebay__skin_10_7_1__field*/
set(function __9999ebay__skin_10_7_1__field(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/field/ds6/field.css')*/
  ;
});

/*id = 13. Removing type: def of /@ebay/skin$10.7.1/radio. Replaced with function declaration __9999ebay__skin_10_7_1__radio*/
set(function __9999ebay__skin_10_7_1__radio(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/radio/ds6/radio.css')*/
  ;
});

/*id = 14. Removing type: def of /@ebay/skin$10.7.1/select. Replaced with function declaration __9999ebay__skin_10_7_1__select*/
set(function __9999ebay__skin_10_7_1__select(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/select/ds6/select.css')*/
  ;
});

/*id = 15. Removing type: def of /@ebay/skin$10.7.1/switch. Replaced with function declaration __9999ebay__skin_10_7_1__switch*/
set(function __9999ebay__skin_10_7_1__switch(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/switch/ds6/switch.css')*/
  ;
});

/*id = 16. Removing type: def of /@ebay/skin$10.7.1/textbox. Replaced with function declaration __9999ebay__skin_10_7_1__textbox*/
set(function __9999ebay__skin_10_7_1__textbox(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/textbox/ds6/textbox.css')*/
  ;
});

/*id = 17. Removing type: def of /@ebay/skin$10.7.1/form. Replaced with function declaration __9999ebay__skin_10_7_1__form*/
set(function __9999ebay__skin_10_7_1__form(require, exports, module, __filename, __dirname) {
  /*id: 10, module: __9999ebay__skin_10_7_1__button*/
  require(get(10));

  /*id: 11, module: __9999ebay__skin_10_7_1__checkbox*/
  require(get(11));

  /*id: 12, module: __9999ebay__skin_10_7_1__field*/
  require(get(12));

  /*id: 13, module: __9999ebay__skin_10_7_1__radio*/
  require(get(13));

  /*id: 14, module: __9999ebay__skin_10_7_1__select*/
  require(get(14));

  /*id: 15, module: __9999ebay__skin_10_7_1__switch*/
  require(get(15));

  /*id: 16, module: __9999ebay__skin_10_7_1__textbox*/
  require(get(16));
});

/*id = 18. Removing type: def of /@ebay/skin$10.7.1/spinner. Replaced with function declaration __9999ebay__skin_10_7_1__spinner*/
set(function __9999ebay__skin_10_7_1__spinner(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/spinner/ds6/spinner.css')*/
  ;
});

/*id = 19. Removing type: def of /ebay-font$1.2.3/font/marketsans/fontloader. Replaced with function declaration __ebay_font_1_2_3__font__marketsans__fontloader*/
set(function __ebay_font_1_2_3__font__marketsans__fontloader(require, exports, module, __filename, __dirname) {
  ...
  function updateLocalStorage() {
    ...
    } catch (ex) {// Either localStorage not present or quota has exceeded
...
/*Removing type: run of /ebay-font$1.2.3/font/marketsans/fontloader. Self-invocation injected for id=19 of __ebay_font_1_2_3__font__marketsans__fontloader*/
run(get(19));

/*id = 20. Removing type: def of /@ebay/skin$10.7.1/marketsans. Replaced with function declaration __9999ebay__skin_10_7_1__marketsans*/
set(function __9999ebay__skin_10_7_1__marketsans(require, exports, module, __filename, __dirname) {
  void 0
  /*require('./dist/marketsans/marketsans.css')*/
  ;
});

/*id = 21. Removing type: def of /cookies-browser$0.0.2/index. Replaced with function declaration __cookies_browser_0_0_2__index*/
set(function __cookies_browser_0_0_2__index(require, exports, module, __filename, __dirname) {
  /**
  ...
  */
  ...
  var api = {
    ...
    */
    ...
    createDefaultCookieBean: function createDefaultCookieBean(psCookie, psCookielet) {
      ...
      cookie.name = psCookie; // string

      cookie.cookieletname = psCookielet; // string

      cookie.value = ""; // date in millisecs UTC
    ...
    readCookieObj: function readCookieObj(psCookie, psCookielet) {
      ...
      this.update();
      this.checkConversionMap(cookie); // returns the raw value of the cookie from document.cookie
      // raw value

      cookie.rawcookievalue = this.aCookies[cookie.name]; // TODO - determine why this is required
    ...
    checkConversionMap: function checkConversionMap(cookie) {
      ...
      var cmap = aConversionMap[cookie.name]; // if cookielet is in conversio map then do the following
    ...
    readCookieletInternal: function readCookieletInternal(cookie) {
      var clet = this.getCookielet(cookie.name, cookie.cookieletname, cookie.rawcookievalue); // handling formats of cookielets mentiond in aFormatMap
    ...
    writeRawCookie: function writeRawCookie(psCookie, psVal, psExp) {
      ...
      if (psCookie && psVal !== undefined) {
        ...
        if (isNaN(psVal) && psVal.length < 4000 || (psVal + '').length < 4000) {
          ...
          var format = this.getFormat(psCookie); //TODO: refactor domain logic before E513

          var sHost = this.sCookieDomain;
          var dd = document.domain; //if (!dd.has(sHost)) {
          ...
          if (document.cookie) {
            document.cookie = psCookie + "=" + (psVal || "") + (psExp || format.bUseExp ? "; expires=" + expDate.toGMTString() : "") + "; domain=" + this.sCookieDomain + "; path=" + sPath; //        "; secure=" + secure;
          }
        }
      }
    },
    ...
    writeCookielet: function writeCookielet(psCookie, psCookielet, psVal, psExp, psContExp) {
      ...
      if (psCookie && psCookielet) {
        ...
        if (format.bUseExp && psVal) {
          ...
          expDateUTC = Math.floor(expDateUTC / 1000); //psVal += expDateUTC.dec2Hex();
    ...
    */
    ...
    setBitFlagOldVersion: function setBitFlagOldVersion(piDec, piPos, piVal) {
      ...
      p = b.length - piPos - 1; //replacing value at pPos with pVal and converting back to decimal
    ...
    */
    ...
    getMode: function getMode(psCookie) {
      ...
      if (h && h != "0") {
        ...
        if (h.indexOf(".") !== -1) {
          ...
          var a = h.split("."); //looping through array
        ...
        i = 0; //getting total binary string length

        var l = b.length,
            j; //looping through each cookie and filling mode of the cookie

        for (var o in aConversionMap) {
          //find the position to read
          j = l - 2 * (i + 1); //reading backwards 2 digits at a time
    ...
    setMulti: function setMulti(piDec, piPos, piBits, piVal) {
      var i = 0,
          ...
          v,
          l,
          e; //convert to binary and take piBits out of it
  ...
  eventInit(); // expose the API in windows for core platform services - Tracking & EP

  window['cookies-browser'] = api; // expose the API as CommonJS module

  module.exports = api;
});

/*Removing type: run of /cookies-browser$0.0.2/index. Self-invocation injected for id=21 of __cookies_browser_0_0_2__index*/
run(get(21));

/*id = 22. Removing type: def of /core-site-speed-ebay$1.0.14/SiteSpeed. Replaced with function declaration __core_site_speed_ebay_1_0_14__SiteSpeed*/
set(function __core_site_speed_ebay_1_0_14__SiteSpeed(require, exports, module, __filename, __dirname) {
    ...
    function SiteSpeed(context) {
      function getResourceTimingTag() {
        ...
        function join(ranges) {
          ...
          range += current[1] - current[0]; //startOffset_range_duration
        ...
        entries.forEach(function (entry, i) {
          var requestStart = entry.requestStart; //cross domain case, use fetchStart instead
          ...
          var theInitiatorType = entry.initiatorType; //work around since notice that firefox use 'subdocument' instead of 'iframe'
          ...
          hosts[host]['all'].push([requestStart, entry.responseEnd]); //  add to all hosts case
        ...
        var rsTimingTag = ''; // generate beacon url for fixed part: nonEbayHosts, ebayHosts and allHosts
...
/*id = 23. Removing type: def of /site-speed-ebay$5.4.3/client/uri. Replaced with function declaration __site_speed_ebay_5_4_3__client__uri*/
set(function __site_speed_ebay_5_4_3__client__uri(require, exports, module, __filename, __dirname) {
  ...
  */
  ...
  var uriMatch = new RegExp('(([^:]*)://([^:/?]*)(:([0-9]+))?)?([^?#]*)([?]([^#]*))?(#(.*))?'); // as Object.assign has issues only on IE11
...
/*id = 24. Removing type: def of /site-speed-ebay$5.4.3/client/metrics. Replaced with function declaration __site_speed_ebay_5_4_3__client__metrics*/
set(function __site_speed_ebay_5_4_3__client__metrics(require, exports, module, __filename, __dirname) {
  'use strict';
...
/*id = 25. Removing type: def of /site-speed-ebay$5.4.3/client/sitespeed. Replaced with function declaration __site_speed_ebay_5_4_3__client__sitespeed*/
set(function __site_speed_ebay_5_4_3__client__sitespeed(require, exports, module, __filename, __dirname) {
  window.$ssg = function (gaugeInfo) {
    // jshint ignore:line
    var metrics =
    /*id: 24, module: __site_speed_ebay_5_4_3__client__metrics*/
    require(get(24))();

    var Uri =
    /*id: 23, module: __site_speed_ebay_5_4_3__client__uri*/
    require(get(23));

    var ebayCookies =
    /*id: 21, module: __cookies_browser_0_0_2__index*/
    require(get(21));

    var sitespeed =
    /*id: 22, module: __core_site_speed_ebay_1_0_14__SiteSpeed*/
    require(get(22));
...
/*Removing type: run of /site-speed-ebay$5.4.3/client/sitespeed. Self-invocation injected for id=25 of __site_speed_ebay_5_4_3__client__sitespeed*/
run(get(25));
})($_mod.get, $_mod.set, $_mod.run);
