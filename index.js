...
const lassoModulesMeta = require('./lib/lasso-prop-types');
const { isLassoModule,
    isLassoClientSideRuntime
} = require('./lib/lasso-optimizer-utils');
const getLassoModuleData = require('./lib/lasso-module-data-extractor');
const genVarsByGroupSize = require('./lib/var-name-gen');
